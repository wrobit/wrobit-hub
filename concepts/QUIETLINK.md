...
- **Server**: No persistent message store. PreKey Service stores _only_ public keys. Relay may temporarily hold encrypted bundles in memory/ephemeral queue for asynchronous delivery.
...
1. **Subscription / Premium Model**

   - Monthly/annual subscription for advanced features:
     - Multi-device sync
     - Ephemeral messages or extended history
     - Custom themes or UX customization
     - Priority support or faster message delivery in congested networks

2. **Device/Account Add-ons**

   - Pay for multiple device support or enterprise/business usage.
   - API access for businesses requiring secure internal communications.

3. **Self-host / Enterprise Licensing**

   - Offer self-hosted version for companies, organizations, or privacy-conscious groups.
   - Licensing fees for deployment, updates, and support.

4. **Optional In-App Donations / “Support the App”**

   - One-time contributions to sustain a privacy-first project.

**Unsuitable:** Advertising, selling user data, analytics-driven features.
